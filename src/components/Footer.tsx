...
import qrImage from '../assets/whatsapp-qr.png';
  ...
  return (
    <footer id="contact" className="relative mt-px border-t border-gold-500/20 bg-noir-950">
      ...
      <div className="border-t border-gold-500/10 py-6">
        <p className="lux-container text-center text-xs text-gray-500">
          © 2026 Silopi VIP Araç Kiralama. Tüm hakları saklıdır.
        </p>
      </div>
    </footer>
  );
